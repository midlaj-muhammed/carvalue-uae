  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[600px] h-[400px] bg-gradient-radial from-primary-light/[0.04] via-transparent to-transparent rounded-full blur-3xl" />
